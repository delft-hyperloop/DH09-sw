...
export type NamedCommand =
    ...
    | 'PropulsionOn'
    | 'MotorBrake'
    | 'SendPropulsionControlWord1'
    | 'SendPropulsionControlWord2'
    | 'PPControlParams'
    | 'PPDebugParams1'
    | 'PPDebugParams2'
    | 'PPTestControlParams'
    ...
    | 'FaultFixed'
    | 'FailLeviSystemCheck'
    | 'FailProp1SystemCheck'
    | 'FailProp2SystemCheck'
    | 'ReconnectEmergency'
    | 'OverrideRearmSdc';
...
export const bmsErrorInternal = [
    'No Fault', // 0
    'Incorrect module count', // 1
    'No current sensing', // 2
    'Failed self test', // 3
    'Failed ADC self test', // 4
    'Failed auxiliary ADC self test', // 5
    'Failed status register self test', // 6
    'Failed ISOSPI', // 7
    'Conversion timeout', // 8
    'Open wire detected', // 9
    'Too many failed cell voltage readings', //10
];
