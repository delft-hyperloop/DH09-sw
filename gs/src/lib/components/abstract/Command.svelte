...
<button disabled={disabled} class="btn rounded-md font-number font-medium text-wrap flex-wrap overflow-hidden {className ? className : 'bg-primary-500 text-surface-900'}"
        on:click={send}>
    {#if icon}
        <div class="mr-1">
