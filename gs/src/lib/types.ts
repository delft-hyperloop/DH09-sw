...
export type NamedCommand = "DefaultCommand" | "Heartbeat" | "FrontendHeartbeat" | "EmitEvent" | "StartHV" | "StopHV" | "LevitationOn" | "LevitationOff" | "vertical_0_current" | "vert_0_current_reset" | "PropulsionOn" | "PropulsionOff" | "SendPropulsionControlWord" | "PPControlParams" | "PPDebugParams1" | "PPDebugParams2" | "PPTestControlParams" | "SubmitDirection" | "SubmitSpeed" | "ArmBrakes" | "Shutdown" | "EmergencyBrake" | "SystemReset";
export const NamedCommandValues:NamedCommand[] = [
    "DefaultCommand", "Heartbeat", "FrontendHeartbeat", "EmitEvent", "StartHV", "StopHV", "LevitationOn", "LevitationOff", "vertical_0_current", "vert_0_current_reset", "PropulsionOn", "PropulsionOff", "SendPropulsionControlWord", "PPControlParams", "PPDebugParams1", "PPDebugParams2", "PPTestControlParams", "SubmitDirection", "SubmitSpeed", "ArmBrakes", "Shutdown", "EmergencyBrake", "SystemReset"];

export type NamedDatatype = "TempAmbient0" | "TempAmbient1" | "TempAmbient2" | "BMSVoltageHigh" | "BMSVoltageLow" | "BMSTemperatureHigh" | "BMSTemperatureLow" | "TempRangeStart" | "TempRangeEnd" | "Loc1" | "Loc2" | "Temp0" | "Temp1" | "Temp2" | "Temp3" | "Temp4" | "Temp5" | "Temp6" | "Temp7" | "ResetSenseCon" | "ResetPropulsion" | "ModulationFactor1" | "ModulationFactor2" | "MaximumVelocity1" | "MaximumVelocity2" | "Kpq1" | "Kpq2" | "Kiq1" | "Kiq2" | "Kpd1" | "Kpd2" | "Kid1" | "Kid2" | "PositionOffset1" | "PositionOffset2" | "Alpha1" | "Alpha2" | "Iq1" | "Iq2" | "Id1" | "Id2" | "Vq1_C" | "Vq2_C" | "Vd1_C" | "Vd2_C" | "PPEmergency" | "Word" | "IqMeasured" | "IqReference" | "IdMeasured" | "IdReference" | "Vq_Log" | "Vd_Log" | "Vbus" | "Ibus" | "Ta" | "Tb" | "Tc" | "TCASE" | "DefaultDatatype" | "CommandHash" | "EventsHash" | "DataHash" | "ConfigHash" | "ValueError" | "ValueWarning" | "ValueCausedBraking" | "LocalisationHeartbeat" | "SensorHubHeartbeat" | "FrontendHeartbeating" | "PropulsionCurrent" | "Localisation" | "FSMState";
