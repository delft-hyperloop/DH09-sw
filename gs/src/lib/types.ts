...
export type NamedCommand = "DefaultCommand" | "PPTestControlParams" | "PPDebugParams1" | "PPControlParams" | "PPDebugParams2" | "EnablePropulsion" | "DisablePropulsion" | "SendPropulsionControlWord" | "Heartbeat" | "FrontendHeartbeat" | "init" | "reboot" | "launch" | "vert0" | "lat0" | "land" | "vert0_reset" | "lat0_reset" | "SetOverrides" | "EmergencyBrake" | "StartRun" | "ContinueRun" | "StartHV" | "StopHV" | "SystemReset" | "ArmBrakes" | "FinishRunConfig" | "Shutdown" | "DcOff" | "DcOn" | "SetCurrentSpeed" | "CreateDatapoint" | "EmitEvent";
export const NamedCommandValues:NamedCommand[] = ["DefaultCommand", "PPTestControlParams", "PPDebugParams1", "PPControlParams", "PPDebugParams2", "EnablePropulsion", "DisablePropulsion", "SendPropulsionControlWord", "Heartbeat", "FrontendHeartbeat", "init", "reboot", "launch", "vert0", "lat0", "land", "vert0_reset", "lat0_reset", "SetOverrides", "EmergencyBrake", "StartRun", "ContinueRun", "StartHV", "StopHV", "SystemReset", "ArmBrakes", "FinishRunConfig", "Shutdown", "DcOff", "DcOn", "SetCurrentSpeed", "CreateDatapoint", "EmitEvent"];
