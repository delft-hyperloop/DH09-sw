...
export type NamedCommand = "DefaultCommand" | "EnablePropulsion" | "Prop Control Params" | "Prop Debug Params1" | "Prop Debug Params2" | "Prop Test Control Params" | "DisablePropulsion" | "SendPropulsionControlWord" | "Heartbeat" | "FrontendHeartbeat" | "init" | "reboot" | "launch" | "vert0" | "lat0" | "land" | "vert0_reset" | "lat0_reset" | "SetOverrides" | "EmergencyBrake" | "StartRun" | "ContinueRun" | "StartHV" | "StopHV" | "SystemReset" | "ArmBrakes" | "FinishRunConfig" | "Shutdown" | "DcOff" | "DcOn" | "SetCurrentSpeed" | "CreateDatapoint" | "EmitEvent";
export const NamedCommandValues:NamedCommand[] = ["DefaultCommand", "EnablePropulsion", "Prop Control Params", "Prop Debug Params1", "Prop Debug Params2", "Prop Test Control Params", "DisablePropulsion", "SendPropulsionControlWord", "Heartbeat", "FrontendHeartbeat", "init", "reboot", "launch", "vert0", "lat0", "land", "vert0_reset", "lat0_reset", "SetOverrides", "EmergencyBrake", "StartRun", "ContinueRun", "StartHV", "StopHV", "SystemReset", "ArmBrakes", "FinishRunConfig", "Shutdown", "DcOff", "DcOn", "SetCurrentSpeed", "CreateDatapoint", "EmitEvent"];

/*AUTO GENERATED USING npm run generate:datatypes */
export type NamedDatatype = "DefaultDatatype" | "GoingForward" | "Velocity" | "IqMeasured" | "IqReference" | "IdMeasured" | "IdReference" | "Acceleration" | "Direction" | "CommandHash" | "EventsHash" | "DataHash" | "ConfigHash" | "ValueError" | "ValueWarning" | "ValueCausedBraking" | "LocalisationHeartbeat" | "SensorHubHeartbeat" | "FrontendHeartbeating" | "PropulsionCurrent" | "Localisation" | "TempAmbient0" | "TempAmbient1" | "TempAmbient2" | "BMSVoltageHigh" | "BMSVoltageLow" | "BMSTemperatureHigh" | "BMSTemperatureLow" | "TempRangeStart" | "TempRangeEnd" | "Loc1" | "Loc2" | "Loc3" | "Loc4" | "Temp0" | "Temp1" | "Temp2" | "Temp3" | "Temp4" | "Temp5" | "Temp6" | "Temp7" | "ResetSenseCon" | "ResetPropulsion" | "ModulationFactor1" | "ModulationFactor2" | "MaximumVelocity1" | "MaximumVelocity2" | "Kpq1" | "Kpq2" | "Kiq1" | "Kiq2" | "Kpd1" | "Kpd2" | "Kid1" | "Kid2" | "PositionOffset1" | "PositionOffset2" | "Alpha1" | "Alpha2" | "Iq1" | "Iq2" | "Id1" | "Id2" | "Vq1_C" | "Vq2_C" | "Vd1_C" | "Vd2_C" | "PPEmergency" | "Word1" | "Word2" | "IqMeasured1" | "IqMeasured2" | "IqReference1" | "IqReference2" | "Vq1_Log" | "Vq2_Log" | "Vd1_Log" | "Vd2_Log" | "Vbus1" | "Vbus2" | "Ibus1" | "Ibus2" | "Ta1" | "Ta2" | "Tb1" | "Tb2" | "Tc1" | "Tc2";
export const NamedDatatypeValues = ["YourNewDatatypeName" , "PropIQMeasured", "PropIQReference", "PropIDMeasured", "PropIDReference", "Ta", "Tb", "Tc", "Tcase", "VQ", "VD", "Vbus", "Ibus", "Example1" , "Example2" , "Example3" , "DefaultDatatype" , "ConnectionStatus" , "PropulsionVoltage" , "PropulsionCurrent" , "PropulsionVRefInt" ,
